###############################################################################
#               Michael C. Knaus, St. Gallen, 06.04.2022                      #
# This file produces the dataset that underlies the analysis of the paper     #
# "Double machine learning based program evaluation under unconfoundedness"   #
# The raw dataset "1203_ALMP_Data_E_v1.0.0.csv" can be requested via the FORS #
# database (https://forsbase.unil.ch/project/study-public-overview/17035/1/). #
# It is not a public use file but researchers can request access via the      #
# infrastructure of the FORS database.                                        #
# After receiving the data, save the file "Swiss_ALMP.csv" in a folder of     #
# your choice, change the working directory in line 16 and run the file.      #
...
setwd("D:/Switch/Papers/Multi Treat Labor/Paper/Data")
...
# Read data
db = read.csv("1203_ALMP_Data_E_v1.0.0.csv")
...
save(y,w,x,z_blp,x_pt_low,x_pt_high,label_x,label_w,file="Database_SALMP_MCK2022.Rdata")