...
My research interests are at the intersection of causal inference and machine learning to answer questions in empirical economics. In particular I am currently working on the estimation of *average* and *heterogeneous* treatment effects as well as optimal policy allocation. See my [research section](https://mcknaus.github.io/menu/research.html) for more details.
